...
#define DDE_INVALID_CRC                "%s (%s@%d) Invalid CRC [expected=0x%x, received=0x%x]"
...
#define DDE_INVALID_STRUCT_SIZE        "%s (%s@%d) Invalid %s size [id=%d, size=%d, expected=%d]"
#define DDE_INVALID_DATA               "%s (%s@%d) Invalid data [id=%d]"
#define DDE_INVALID_DATA_TYPE          "%s (%s@%d) Invalid data type [id=%d, expected=%s, requested=%s]"
