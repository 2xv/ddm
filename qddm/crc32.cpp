...
const unsigned int crc32::crc32_table [] =
...
unsigned int crc32::update (unsigned int crc, int buf_size, void *buf)
{
    unsigned char *b = static_cast <unsigned char *> (buf);

    crc ^= 0xFFFFFFFF;
    for (int i = 0; i < buf_size; i++) crc = (crc >> 8) ^ crc32_table [(crc ^ b [i]) & 0xFF];
