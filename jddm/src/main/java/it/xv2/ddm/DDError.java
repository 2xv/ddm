...
{                           //   DDBuffer
    ...
    INVALID_CRC                ("Invalid CRC [expected=0x%s, found=0x%s]"),
    ...
    INVALID_LIST_DATA          ("Invalid data [offset=%s]"),
    ...
    CHECK_IN_STRUCT            ("Value not allowed [id=%s, name=%s]"),
    ...
    INVALID_DATA_TYPE          ("Invalid data type [id=%s, expected=%s, found=%s]"),
    ...
    LIST_PROPERTIES_NOT_FOUND  ("List properties not found [id=%s]"),
